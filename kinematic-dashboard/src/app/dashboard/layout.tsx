...
const C = {
  ...
  red: '#E01E2C', redD: 'rgba(224,30,44,0.12)', redB: 'rgba(224,30,44,0.2)',
...
const MAIN_NAV = [
  ...
  { href: '/dashboard/manpower-directory',  label: 'Manpower Directory', icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 11a4 4 0 100-8 4 4 0 000 8z M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75' },
  ...
  { href: '/dashboard/form-builder',        label: 'Form Builder',  icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 12h6M9 16h4' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh', background:C.bg, fontFamily:"'DM Sans',sans-serif" }}>
      ...
      {/* Sidebar */}
      <aside style={{ width:sideW, flexShrink:0, background:C.side, borderRight:`1px solid ${C.border}`, display:'flex', flexDirection:'column', position:'fixed', top:0, left:0, bottom:0, zIndex:100, transition:'width .2s cubic-bezier(.4,0,.2,1)', overflow:'hidden' }}>
        {/* Logo */}
        <div style={{ height:60, display:'flex', alignItems:'center', padding:collapsed?'0 16px':'0 20px', gap:10, flexShrink:0, borderBottom:`1px solid ${C.border}` }}>
          <div style={{ width:32, height:32, borderRadius:10, background:C.red, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
            <span style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:16, color:'#fff' }}>K</span>
          </div>
          {!collapsed && <span style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:16, color:C.white, whiteSpace:'nowrap' }}>Kinematic</span>}
        </div>
        ...
        <nav style={{ flex:1, overflowY:'auto', overflowX:'hidden', padding:'10px 0' }}>
          ...
          {!collapsed && (
            <>
              <div onClick={()=>setOtherOpen(o=>!o)} style={{ display:'flex', alignItems:'center', gap:10, padding:'10px 16px', margin:'8px 8px 1px', borderRadius:9, color:C.grayd, fontSize:11, fontWeight:700, letterSpacing:'0.7px', textTransform:'uppercase', cursor:'pointer', userSelect:'none' }}>
