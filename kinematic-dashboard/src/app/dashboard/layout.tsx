...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display:'flex', height:'100vh', background:'#080B12', overflow:'hidden' }}>
      ...
      {/* Toggle */}
      <button onClick={() => setCollapsed(c => !c)} style={{ position:'fixed', left: sideW - 14, top:40, zIndex:200, width:28, height:28, borderRadius:'50%', background:'#0E1420', border:'1px solid #1E2D45', display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer', transition:'left 0.25s cubic-bezier(0.22,1,0.36,1)', color:'#7A8BA0' }}>
