...
const mockUsers = () => ({
  success: true,
  data: [
    { id: 'fe1', name: 'Arjun Sharma', employee_id: 'VRN-001', email: 'arjun@demo.in', mobile: '9000000001', role: 'executive', city: 'Bengaluru', is_active: true,
    ...
    { id: 'fe2', name: 'Priya Patel',  employee_id: 'VRN-002', email: 'priya@demo.in', mobile: '9000000002', role: 'executive', city: 'Mumbai',    is_active: true,
      org_role_id: 'demo-role-mr',  org_role: { id: 'demo-role-mr',  name: 'Medical Representative' },
      assigned_cities: ['demo-city-mumbai'], assigned_city_names: ['Mumbai'],
      kini_used_this_month: 12, kini_monthly_cap: 20, permissions: [] },
    { id: 'fe3', name: 'Rahul Verma',  employee_id: 'VRN-003', email: 'rahul@demo.in', mobile: '9000000003', role: 'executive', city: 'Delhi',     is_active: true,
    ...
    { id: 'fe4', name: 'Sneha Rao',    employee_id: 'VRN-004', email: 'sneha@demo.in', mobile: '9000000004', role: 'supervisor', city: 'Hyderabad', is_active: true,
    ...
    { id: 'fe5', name: 'Amit Singh',   employee_id: 'VRN-005', email: 'amit@demo.in',  mobile: '9000000005', role: 'executive', city: 'Pune',      is_active: true,
      org_role_id: 'demo-role-mr',  org_role: { id: 'demo-role-mr',  name: 'Medical Representative' },
...
const mockAttendanceTeam = () => ({
  ...
  data: [
    ...
    },
    {
      ...
      users: { name: 'Priya Patel', employee_id: 'VRN-002' }
    },
    {
      ...
      users: { name: 'Rahul Verma', employee_id: 'VRN-003' }
    }
  ]
});
