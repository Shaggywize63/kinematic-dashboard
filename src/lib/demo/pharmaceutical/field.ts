...
const mockFeed = () => ({
  success: true,
  data: [
    { id: 'f1', time: new Date().toISOString(),                          description: 'Arjun Sharma submitted HCP Detailing Form',     meta: { activity: 'Mounjaro Detailing',        outlet: 'Dr. Anil Mehta (Endocrinology) – Apollo Andheri' } },
    { id: 'f2', time: new Date(Date.now() - 3600000).toISOString(),      description: 'Priya Patel checked in',                         meta: { activity: 'In-Clinic Visit',           outlet: 'Manipal Hospital — Bengaluru' } },
    ...
    { id: 'f4', time: new Date(Date.now() - 10800000).toISOString(),     description: 'Sneha Rao logged Verzenio CME Invitation',      meta: { activity: 'CME Outreach',              outlet: 'Dr. R. K. Tandon – Tata Memorial Centre' } },
    { id: 'f5', time: new Date(Date.now() - 14400000).toISOString(),     description: 'Amit Singh checked out',                         meta: { activity: 'Field Visit',               outlet: 'Apollo Pharmacy — Banjara Hills' } }
  ]
});
...
const mockLocations = () => ({
  ...
  data: {
    ...
    locations: [
      ...
      { id: 'fe5', name: 'Amit Singh',   role: 'senior_executive', battery_percentage: 79, status: 'checked_out',  lat: 12.9378, lng: 77.6305, address: 'BTM Layout — Apollo Pharmacy' }
    ]
  }
});
...
const mockUsers = () => ({
  success: true,
  data: [
    { id: 'fe1', name: 'Arjun Sharma', employee_id: 'LLY-001', email: 'arjun@demo.in', mobile: '9000000001', role: 'executive', city: 'Bengaluru', is_active: true,
    ...
    { id: 'fe2', name: 'Priya Patel',  employee_id: 'LLY-002', email: 'priya@demo.in', mobile: '9000000002', role: 'executive', city: 'Mumbai',    is_active: true,
      org_role_id: 'demo-role-mr',  org_role: { id: 'demo-role-mr',  name: 'Medical Representative' },
      assigned_cities: ['demo-city-mumbai'], assigned_city_names: ['Mumbai'],
      kini_used_this_month: 12, kini_monthly_cap: 20, permissions: [] },
    { id: 'fe3', name: 'Rahul Verma',  employee_id: 'LLY-003', email: 'rahul@demo.in', mobile: '9000000003', role: 'executive', city: 'Delhi',     is_active: true,
    ...
    { id: 'fe4', name: 'Sneha Rao',    employee_id: 'LLY-004', email: 'sneha@demo.in', mobile: '9000000004', role: 'supervisor', city: 'Hyderabad', is_active: true,
    ...
    { id: 'fe5', name: 'Amit Singh',   employee_id: 'LLY-005', email: 'amit@demo.in',  mobile: '9000000005', role: 'executive', city: 'Pune',      is_active: true,
      org_role_id: 'demo-role-mr',  org_role: { id: 'demo-role-mr',  name: 'Medical Representative' },
  ...
  data: [
    {
      ...
      checkin_address: 'Koramangala, Manipal Hospital, Bengaluru',
    ...
    },
    {
      ...
      users: { name: 'Rahul Verma', employee_id: 'LLY-003' }
    }
  ]
});
...
const mockStores = () => ({
  success: true,
  data: [
    { id: 'st1', name: 'Apollo Hospitals — Andheri (Dr. Mehta)',     code: 'HCP-001', address: 'Andheri West, Mumbai',         city: 'Mumbai',    zones: { name: 'Mumbai — West' } },
    { id: 'st2', name: 'Manipal Hospital — Bengaluru (Dr. Iyer)',    code: 'HCP-002', address: 'HAL Old Airport Rd, Bengaluru',city: 'Bengaluru', zones: { name: 'Bengaluru — South' } },
    { id: 'st3', name: 'AIIMS Delhi (Dr. Gupta)',                    code: 'HCP-003', address: 'Ansari Nagar, New Delhi',      city: 'Delhi',     zones: { name: 'Delhi — Central' } },
    { id: 'st4', name: 'Apollo Pharmacy — Greams Road',              code: 'PHM-004', address: 'Greams Road, Chennai',         city: 'Chennai',   zones: { name: 'Chennai — Central' } },
    { id: 'st5', name: 'MedPlus — Banjara Hills',                    code: 'PHM-005', address: 'Banjara Hills, Hyderabad',     city: 'Hyderabad', zones: { name: 'Hyderabad — South' } }
  ]
});
...
const mockFormTemplates = () => ({
  ...
  data: [
    ...
    { id: 't5', name: 'Pharmacy Stock Audit',        description: 'On-shelf availability of Eli Lilly SKUs',                fields_count:  9, created_at: new Date().toISOString() }
  ]
});
...
const mockVisitLogs = () => {
  ...
  return {
    success: true,
    data: [
      { id: 'v1',  visitor_id: 'sup1', visitor_name: 'Vikas Bansal',  visitor_role: 'Regional Sales Manager', executive_id: 'fe1', executive: { name: 'Arjun Sharma', role: 'executive' }, users: { name: 'Arjun Sharma', role: 'executive' }, rating: 'Excellent', remarks: 'Strong Mounjaro detailing — Dr. Mehta agreed to trial Rx on 10 patients next month.',           visited_at: visitedAt(1),  visit_response_at: visitedAt(0.5), visit_response: 'Will share clinical study reprints today.', date: today, stores: { name: 'Apollo Hospitals — Andheri (Dr. Mehta)' }, visit_outlet_id: 'st1', photo_url: PH },
      { id: 'v2',  visitor_id: 'sup1', visitor_name: 'Vikas Bansal',  visitor_role: 'Regional Sales Manager', executive_id: 'fe2', executive: { name: 'Priya Patel',  role: 'executive' }, users: { name: 'Priya Patel',  role: 'executive' }, rating: 'Good',      remarks: 'Sample drop complete. Push Verzenio with oncology unit next visit.',                              visited_at: visitedAt(3),  visit_response_at: null, visit_response: null, date: today, stores: { name: 'Manipal Hospital — Bengaluru (Dr. Iyer)' }, visit_outlet_id: 'st2', photo_url: PH },
      { id: 'v3',  visitor_id: 'sup2', visitor_name: 'Anita Desai',   visitor_role: 'Area Sales Manager',     executive_id: 'fe3', executive: { name: 'Rahul Verma',  role: 'executive' }, users: { name: 'Rahul Verma',  role: 'executive' }, rating: 'Average',   remarks: 'Dr. Gupta wants HbA1c efficacy data over 12 weeks before adopting Mounjaro.',                     visited_at: visitedAt(5),  visit_response_at: visitedAt(4), visit_response: 'Sharing SURMOUNT-1 reprint via WhatsApp.', date: today, stores: { name: 'AIIMS Delhi (Dr. Gupta)' }, visit_outlet_id: 'st3', photo_url: PH },
      { id: 'v4',  visitor_id: 'sup2', visitor_name: 'Anita Desai',   visitor_role: 'Area Sales Manager',     executive_id: 'fe4', executive: { name: 'Sneha Rao',    role: 'executive' }, users: { name: 'Sneha Rao',    role: 'executive' }, rating: 'Excellent', remarks: 'KOL panel buy-in for Verzenio in HR+ breast cancer. CME slot booked for Sep.',                    visited_at: visitedAt(8),  visit_response_at: visitedAt(7), visit_response: 'Targeting 5 referral KOLs this month.', date: today, stores: { name: 'Tata Memorial Centre — Mumbai' }, visit_outlet_id: 'st4', photo_url: PH },
      { id: 'v5',  visitor_id: 'sup1', visitor_name: 'Vikas Bansal',  visitor_role: 'Regional Sales Manager', executive_id: 'fe5', executive: { name: 'Amit Singh',   role: 'executive' }, users: { name: 'Amit Singh',   role: 'executive' }, rating: 'Poor',      remarks: 'HCP not at clinic. Re-attempt tomorrow first thing.',                                              visited_at: visitedAt(10), visit_response_at: null, visit_response: null, date: today, stores: { name: 'Ruby Hall Clinic — Pune (Dr. Kumar)' }, visit_outlet_id: 'st5', photo_url: null },
      { id: 'v6',  visitor_id: 'sup3', visitor_name: 'Rajiv Malhotra', visitor_role: 'Zonal Head',            executive_id: 'fe1', executive: { name: 'Arjun Sharma', role: 'executive' }, users: { name: 'Arjun Sharma', role: 'executive' }, rating: 'Good',      remarks: 'Trulicity adoption strong. Pitch Mounjaro upgrade for T2DM A1c >7.5.',                             visited_at: visitedAt(14), visit_response_at: visitedAt(12), visit_response: 'Switch positioning ready for next visit.', date: today, stores: { name: 'Fortis — Bannerghatta (Dr. Nair)' }, visit_outlet_id: 'st6', photo_url: PH },
      { id: 'v7',  visitor_id: 'sup3', visitor_name: 'Rajiv Malhotra', visitor_role: 'Zonal Head',            executive_id: 'fe2', executive: { name: 'Priya Patel',  role: 'executive' }, users: { name: 'Priya Patel',  role: 'executive' }, rating: 'Excellent', remarks: 'Best MR visit this zone. Detailing discipline + CME conversion exceptional.',                      visited_at: visitedAt(20), visit_response_at: visitedAt(18), visit_response: 'Thank you sir.', date: today, stores: { name: 'Apollo Pharmacy — Greams Road' }, visit_outlet_id: 'st7', photo_url: PH },
      ...
      { id: 'v9',  visitor_id: 'sup1', visitor_name: 'Vikas Bansal',  visitor_role: 'Regional Sales Manager', executive_id: 'fe4', executive: { name: 'Sneha Rao',    role: 'executive' }, users: { name: 'Sneha Rao',    role: 'executive' }, rating: 'Good',      remarks: 'New oncologist Dr. Tandon receptive to Cyramza — schedule literature drop.',                       visited_at: visitedAt(28), visit_response_at: null, visit_response: null, date: today, stores: { name: 'Tata Memorial Centre — Mumbai' }, visit_outlet_id: 'st4', photo_url: null },
      { id: 'v10', visitor_id: 'sup3', visitor_name: 'Rajiv Malhotra', visitor_role: 'Zonal Head',            executive_id: 'fe1', executive: { name: 'Arjun Sharma', role: 'executive' }, users: { name: 'Arjun Sharma', role: 'executive' }, rating: 'Excellent', remarks: 'Patient Support Program enrollment training crisp — all 4 PSP enrolments today.',                  visited_at: visitedAt(32), visit_response_at: visitedAt(30), visit_response: 'Replicating PSP SOP at 3 more clinics next week.', date: today, stores: { name: 'Apollo Hospitals — Andheri (Dr. Mehta)' }, visit_outlet_id: 'st1', photo_url: PH },
      { id: 'v11', visitor_id: 'sup2', visitor_name: 'Anita Desai',   visitor_role: 'Area Sales Manager',     executive_id: 'fe2', executive: { name: 'Priya Patel',  role: 'executive' }, users: { name: 'Priya Patel',  role: 'executive' }, rating: 'Good',      remarks: 'Pharmacy stock audit done — Trulicity 1.5mg low stock, raise PO with distributor.',                 visited_at: visitedAt(36), visit_response_at: visitedAt(34), visit_response: 'Distributor PO raised.', date: today, stores: { name: 'Apollo Pharmacy — Greams Road' }, visit_outlet_id: 'st7', photo_url: PH },
      { id: 'v12', visitor_id: 'sup1', visitor_name: 'Vikas Bansal',  visitor_role: 'Regional Sales Manager', executive_id: 'fe3', executive: { name: 'Rahul Verma',  role: 'executive' }, users: { name: 'Rahul Verma',  role: 'executive' }, rating: 'Average',   remarks: 'Dr. Khanna cold on Verzenio — re-pitch with monarchE 5-year data next month.',                      visited_at: visitedAt(40), visit_response_at: null, visit_response: null, date: today, stores: { name: 'Kokilaben Hospital — Andheri (Dr. Khanna)' }, visit_outlet_id: 'st8', photo_url: PH },
      { id: 'v13', visitor_id: 'sup3', visitor_name: 'Rajiv Malhotra', visitor_role: 'Zonal Head',            executive_id: 'fe5', executive: { name: 'Amit Singh',   role: 'executive' }, users: { name: 'Amit Singh',   role: 'executive' }, rating: 'Excellent', remarks: 'Closed first Mounjaro trial Rx in Pune — Dr. Kumar starting 8-patient pilot.',                      visited_at: visitedAt(44), visit_response_at: visitedAt(42), visit_response: 'Will share trial protocol with team.', date: today, stores: { name: 'Ruby Hall Clinic — Pune (Dr. Kumar)' }, visit_outlet_id: 'st5', photo_url: PH },
      { id: 'v14', visitor_id: 'sup2', visitor_name: 'Anita Desai',   visitor_role: 'Area Sales Manager',     executive_id: 'fe4', executive: { name: 'Sneha Rao',    role: 'executive' }, users: { name: 'Sneha Rao',    role: 'executive' }, rating: 'Good',      remarks: 'Emgality migraine pitch landed — Dr. Verma requested 4 sample pens.',                                visited_at: visitedAt(48), visit_response_at: visitedAt(46), visit_response: 'Samples shipping today.', date: today, stores: { name: 'BLK-Max — Delhi (Dr. Verma)' }, visit_outlet_id: 'st9', photo_url: PH }
    ]
  };
};
...
const mkSub = (
  ...
  const answers = withDocs
    ...
    : [
        { label: 'Key Message Delivered', qtype: 'short_text', value: 'Mounjaro — A1c reduction & weight loss benefit' },
...
const mockSubmissions = () => ({
  ...
  total: 1820,
  data: [
    mkSub('s1', 95,  38, true,  'Dr. Anil Mehta (Endocrinology)',  'Arjun Sharma', 'LLY-001', 'HCP Detailing Form',          'Mounjaro Detailing',  'Apollo Hospitals — Andheri',     false),
    mkSub('s2', 180, 26, false, 'Dr. Kavita Iyer (Oncology)',      'Priya Patel',  'LLY-002', 'Sample Drop Acknowledgement', 'Sampling',            'Manipal Hospital — Bengaluru',   true),
    mkSub('s3', 240, 42, true,  'Dr. Neha Gupta (Endocrinology)',  'Rahul Verma',  'LLY-003', 'HCP Detailing Form',          'Trulicity Detailing', 'AIIMS Delhi',                     false),
    mkSub('s4', 320, 21, true,  'Apollo Pharmacy — Greams Road',   'Sneha Rao',    'LLY-004', 'Pharmacy Stock Audit',         'Pharmacy Audit',      'Greams Road, Chennai',           false),
    mkSub('s5', 410, 33, false, 'Dr. Karan Verma (Neurology)',     'Amit Singh',   'LLY-005', 'Sample Drop Acknowledgement', 'Sampling',            'BLK-Max — Delhi',                 true),
    mkSub('s6', 520, 29, true,  'Dr. R. K. Tandon (Oncology)',     'Rahul Verma',  'LLY-003', 'CME Invitation RSVP',          'CME Outreach',        'Tata Memorial Centre — Mumbai',  true)
  ]
});
...
const mockBroadcasts = () => ({
  success: true,
  data: [
    { id: 'b1', title: 'Mounjaro India launch sprint',     body: 'Eli Lilly Mounjaro launched in India. Prioritise top-200 endo / diabetologist HCPs this cycle — see launch kit.',                  sent_at: new Date(Date.now() -  1*86400000).toISOString(), sent_by: 'Demo Admin', recipients: 160, read: 152 },
    { id: 'b2', title: 'Pharmacovigilance reminder',        body: 'All Adverse Event reports MUST be filed within 24h. Use the AE form in-app and CC pv-india@lilly.demo.',                            sent_at: new Date(Date.now() -  3*86400000).toISOString(), sent_by: 'Demo Admin', recipients: 160, read: 158 },
    { id: 'b3', title: 'Verzenio monarchE 5yr data',        body: 'Updated monarchE 5-year DFS data slides available in the eDetailer. Use for Adjuvant breast cancer detailing.',                       sent_at: new Date(Date.now() -  5*86400000).toISOString(), sent_by: 'Demo Admin', recipients: 160, read: 137 },
    ...
    { id: 'b5', title: 'Patient Support Program update',    body: 'PSP enrolment fee waived for Mounjaro starters till Mar 2027 — Lilly Cares scheme details attached.',                                 sent_at: new Date(Date.now() - 14*86400000).toISOString(), sent_by: 'Demo Admin', recipients: 160, read: 155 },
    ...
    { id: 'b8', title: 'Trulicity → Mounjaro switch deck',   body: 'New comparison deck for tirzepatide vs dulaglutide is live. Use for treatment-intensification conversations.',                       sent_at: new Date(Date.now() - 28*86400000).toISOString(), sent_by: 'Demo Admin', recipients: 160, read: 149 }
  ]
});
...
const mockBroadcastAdmin = () => {
  ...
  return {
    ...
    data: [
      ...
      { id: 'bq6', question: 'Are you using the new Mounjaro eDetailer v2?', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }], correct_option: null, is_urgent: false, deadline_at: _at(-18), status: 'closed', target_roles: ['executive'], target_zone_ids: [], target_cities: [], created_at: _at(18), response_count: 156, tally: [{ label: 'Yes', index: 0, count: 138 }, { label: 'No', index: 1, count: 18 }], responses: [] },
...
const mockLearningMaterials = () => ({
  ...
  data: [
    ...
    { id: 'l2', title: 'Mounjaro — Detailing Guide',                category: 'Product',        updated_at: new Date(Date.now() - 14*86400000).toISOString(), kind: 'video' },
    ...
    { id: 'l4', title: 'Verzenio monarchE 5-yr Data Deep-Dive',     category: 'Clinical',        updated_at: new Date(Date.now() - 21*86400000).toISOString(), kind: 'video' },
...
const ROUTE_PLANS = (() => {
  const fes = [
    { id: 'demo-fe-1', name: 'Arjun Sharma',   employee_id: 'LLY-1042', mobile: '+91 98201 11111', zone: 'Bengaluru — South',     city: 'Bengaluru' },
    { id: 'demo-fe-2', name: 'Priya Patel',    employee_id: 'LLY-1051', mobile: '+91 98202 22222', zone: 'Mumbai — West',         city: 'Mumbai' },
    { id: 'demo-fe-3', name: 'Rahul Verma',    employee_id: 'LLY-1063', mobile: '+91 98203 33333', zone: 'Delhi — Central',       city: 'Delhi' },
    { id: 'demo-fe-4', name: 'Sneha Rao',      employee_id: 'LLY-1078', mobile: '+91 98204 44444', zone: 'Chennai — Central',     city: 'Chennai' },
    { id: 'demo-fe-5', name: 'Amit Singh',     employee_id: 'LLY-1085', mobile: '+91 98205 55555', zone: 'Hyderabad — South',     city: 'Hyderabad' },
    { id: 'demo-fe-6', name: 'Karthik Pillai', employee_id: 'LLY-1092', mobile: '+91 98206 66666', zone: 'Pune — East',           city: 'Pune' },
    { id: 'demo-fe-7', name: 'Pooja Joshi',    employee_id: 'LLY-1107', mobile: '+91 98207 77777', zone: 'Ahmedabad — West',      city: 'Ahmedabad' },
    { id: 'demo-fe-8', name: 'Manish Khanna',  employee_id: 'LLY-1118', mobile: '+91 98208 88888', zone: 'Kolkata — North',       city: 'Kolkata' },
  ];
  ...
  const storeNames = [
    'Dr. Anil Mehta (Endo)', 'Dr. Kavita Iyer (Onco)', 'Apollo Pharmacy',
    'Dr. Neha Gupta (Endo)', 'AIIMS Delhi', 'MedPlus Pharmacy',
    'Dr. Manish Khanna (Onco)', 'Fortis Hospital',
    'Dr. Karan Verma (Neuro)', 'Tata Memorial Centre',
  ];
  ...
  return Array.from({ length: 10 }, (_, i) => {
    ...
    const outlets = Array.from({ length: total }, (_, j) => {
      ...
      return {
        ...
        target_notes: ['Detail Mounjaro key messages', 'Drop 4-pack sample with signature', 'Invite to weekend CME — diabetes', 'Audit OSA + book PO if low'][j % 4],
    ...
    return {
      ...
      status,
      notes: i % 4 === 0 ? 'Mounjaro launch sprint — prioritise top endo / diabetologists' : undefined,
