...
// cardiologists, rheumatologists prescribing within Vireon Pharma's portfolio.
// "company" carries the hospital/clinic, "title" the specialty.
export const CRM_LEADS = [
  { id: 'demo-lead-1',  first_name: 'Dr. Anil',     last_name: 'Mehta',    company: 'Sunrise Hospitals — Andheri',     email: 'dr.amehta@sunrise.demo',       phone: '+91 98201 11111', status: 'qualified',   score: 92, score_grade: 'A', city: 'Mumbai',    state: 'Maharashtra', latitude: 19.072, longitude: 72.881, industry: 'Pharmaceutical', specialty: 'Endocrinology',   product_interest: 'Glucanova',  monthly_rx_potential: 240, owner_id: 'demo-user-id', owner_name: MRS[0], source_id: 'demo-src-1', last_activity_at: _now(-1),  created_at: _now(-14) },
  { id: 'demo-lead-2',  first_name: 'Dr. Kavita',   last_name: 'Iyer',     company: 'Meridian Hospital — Bengaluru',   email: 'dr.kiyer@meridian.demo',       phone: '+91 98202 22222', status: 'working',     score: 78, score_grade: 'A', city: 'Bengaluru', state: 'Karnataka',   latitude: 12.965, longitude: 77.585, industry: 'Pharmaceutical', specialty: 'Oncology',        product_interest: 'Oncevia',  monthly_rx_potential: 120, owner_id: 'demo-user-id', owner_name: MRS[1], source_id: 'demo-src-2', last_activity_at: _now(-2),  created_at: _now(-21) },
  { id: 'demo-lead-3',  first_name: 'Dr. Suresh',   last_name: 'Kumar',    company: 'Emerald Clinic — Pune',        email: 'dr.skumar@emeraldclinic.demo',     phone: '+91 98203 33333', status: 'new',         score: 64, score_grade: 'B', city: 'Pune',      state: 'Maharashtra', latitude: 18.516, longitude: 73.857, industry: 'Pharmaceutical', specialty: 'Diabetology',     product_interest: 'Diabextra', monthly_rx_potential:  85, owner_id: 'demo-user-id', owner_name: MRS[2], source_id: 'demo-src-3', last_activity_at: _now(-4),  created_at: _now(-7)  },
  { id: 'demo-lead-4',  first_name: 'Dr. Neha',     last_name: 'Gupta',    company: 'Horizon Hospitals — Hyderabad',      email: 'dr.ngupta@horizonhospitals.demo', phone: '+91 98204 44444', status: 'qualified',   score: 95, score_grade: 'A', city: 'Hyderabad', state: 'Telangana',   latitude: 17.392, longitude: 78.486, industry: 'Pharmaceutical', specialty: 'Endocrinology',   product_interest: 'Glucanova',  monthly_rx_potential: 310, owner_id: 'demo-user-id', owner_name: MRS[0], source_id: 'demo-src-4', last_activity_at: _now(-1),  created_at: _now(-30) },
  { id: 'demo-lead-5',  first_name: 'Dr. Karthik',  last_name: 'Pillai',   company: 'Sunrise — Greams Road, Chennai',  email: 'dr.kpillai@sunrise.demo',      phone: '+91 98205 55555', status: 'working',     score: 58, score_grade: 'B', city: 'Chennai',   state: 'Tamil Nadu',  latitude: 13.082, longitude: 80.270, industry: 'Pharmaceutical', specialty: 'Cardiology',      product_interest: 'Glyzentia', monthly_rx_potential:  72, owner_id: 'demo-user-id', owner_name: MRS[3], source_id: 'demo-src-5', last_activity_at: _now(-5),  created_at: _now(-18) },
  { id: 'demo-lead-6',  first_name: 'Dr. Pooja',    last_name: 'Joshi',    company: 'Central City Hospital — Jaipur',          email: 'dr.pjoshi@centralcityhospital.demo',  phone: '+91 98206 66666', status: 'unqualified', score: 22, score_grade: 'D', city: 'Jaipur',    state: 'Rajasthan',   latitude: 26.912, longitude: 75.792, industry: 'Pharmaceutical', specialty: 'General Medicine',product_interest: 'Insulora',   monthly_rx_potential:  18, owner_id: 'demo-user-id', owner_name: MRS[4], source_id: 'demo-src-6', last_activity_at: _now(-9),  created_at: _now(-35) },
  { id: 'demo-lead-7',  first_name: 'Dr. Manish',   last_name: 'Khanna',   company: 'Lakeview — Andheri West',       email: 'dr.mkhanna@lakeview.demo',   phone: '+91 98207 77777', status: 'qualified',   score: 84, score_grade: 'A', city: 'Mumbai',    state: 'Maharashtra', latitude: 19.101, longitude: 72.845, industry: 'Pharmaceutical', specialty: 'Oncology',        product_interest: 'Oncevia',  monthly_rx_potential: 165, owner_id: 'demo-user-id', owner_name: MRS[1], source_id: 'demo-src-2', last_activity_at: _now(-3),  created_at: _now(-25) },
  { id: 'demo-lead-8',  first_name: 'Dr. Ishaan',   last_name: 'Bose',     company: 'Riverside Hospitals — Salt Lake',     email: 'dr.ibose@riverside.demo',          phone: '+91 98208 88888', status: 'nurturing',   score: 48, score_grade: 'C', city: 'Kolkata',   state: 'West Bengal', latitude: 22.572, longitude: 88.363, industry: 'Pharmaceutical', specialty: 'Rheumatology',    product_interest: 'Rheumolex',  monthly_rx_potential:  62, owner_id: 'demo-user-id', owner_name: MRS[2], source_id: 'demo-src-3', last_activity_at: _now(-12), created_at: _now(-42) },
  { id: 'demo-lead-9',  first_name: 'Dr. Tanvi',    last_name: 'Mehta',    company: 'Cornerstone Hospital — Ahmedabad',  email: 'dr.tmehta@cornerstone.demo',     phone: '+91 98209 99999', status: 'new',         score: 70, score_grade: 'B', city: 'Ahmedabad', state: 'Gujarat',     latitude: 23.031, longitude: 72.582, industry: 'Pharmaceutical', specialty: 'Diabetology',     product_interest: 'Diabextra', monthly_rx_potential:  98, owner_id: 'demo-user-id', owner_name: MRS[3], source_id: 'demo-src-1', last_activity_at: _now(-1),  created_at: _now(-5)  },
  { id: 'demo-lead-10', first_name: 'Dr. Karan',    last_name: 'Verma',    company: 'Northgate — Delhi',                email: 'dr.kverma@northgate.demo',       phone: '+91 98210 10101', status: 'working',     score: 88, score_grade: 'A', city: 'Delhi',     state: 'Delhi',       latitude: 28.613, longitude: 77.209, industry: 'Pharmaceutical', specialty: 'Neurology',       product_interest: 'Migranova',  monthly_rx_potential: 140, owner_id: 'demo-user-id', owner_name: MRS[0], source_id: 'demo-src-7', last_activity_at: _now(-2),  created_at: _now(-11) },
  { id: 'demo-lead-11', first_name: 'Dr. Aditya',   last_name: 'Nair',     company: 'Crescent — Bannerghatta, Bengaluru', email: 'dr.anair@crescent.demo',      phone: '+91 98211 12121', status: 'qualified',   score: 81, score_grade: 'A', city: 'Bengaluru', state: 'Karnataka',   latitude: 12.892, longitude: 77.598, industry: 'Pharmaceutical', specialty: 'Endocrinology',   product_interest: 'Glucanova',  monthly_rx_potential: 205, owner_id: 'demo-user-id', owner_name: MRS[1], source_id: 'demo-src-5', last_activity_at: _now(-1),  created_at: _now(-28) },
  { id: 'demo-lead-12', first_name: 'Dr. Diya',     last_name: 'Kapoor',   company: 'Trinity International — Chennai',   email: 'dr.dkapoor@trinity.demo',        phone: '+91 98212 13131', status: 'new',         score: 38, score_grade: 'C', city: 'Chennai',   state: 'Tamil Nadu',  latitude: 13.052, longitude: 80.251, industry: 'Pharmaceutical', specialty: 'Oncology',        product_interest: 'Oncevia',  monthly_rx_potential:  55, owner_id: 'demo-user-id', owner_name: MRS[2], source_id: 'demo-src-2', last_activity_at: _now(-6),  created_at: _now(-9)  },
  { id: 'demo-lead-13', first_name: 'Dr. Rajeev',   last_name: 'Krishnan', company: 'Kaveri Hospital — Trivandrum',     email: 'dr.rkrishnan@kaveri.demo',      phone: '+91 98213 14141', status: 'qualified',   score: 86, score_grade: 'A', city: 'Trivandrum',state: 'Kerala',      latitude: 8.524,  longitude: 76.937, industry: 'Pharmaceutical', specialty: 'Endocrinology',   product_interest: 'Diabextra', monthly_rx_potential: 175, owner_id: 'demo-user-id', owner_name: MRS[3], source_id: 'demo-src-4', last_activity_at: _now(-2),  created_at: _now(-17) },
  { id: 'demo-lead-14', first_name: 'Dr. Sunita',   last_name: 'Menon',    company: 'Ashwin — Hyderabad',            email: 'dr.smenon@ashwin.demo',      phone: '+91 98214 15151', status: 'working',     score: 74, score_grade: 'B', city: 'Hyderabad', state: 'Telangana',   latitude: 17.428, longitude: 78.451, industry: 'Pharmaceutical', specialty: 'Oncology',        product_interest: 'Oncorib',   monthly_rx_potential:  88, owner_id: 'demo-user-id', owner_name: MRS[4], source_id: 'demo-src-1', last_activity_at: _now(-4),  created_at: _now(-19) },
];
...
export const CRM_PIPELINES = [
  { id: 'demo-pipe',               name: 'Vireon Pharma — HCP Engagement', is_default: true,  stages: CRM_STAGES },
...
export const CRM_CONTACTS = [
  ...
  { id: 'demo-ctc-7', first_name: 'Dr. Manish', last_name: 'Khanna',    email: 'dr.mkhanna@lakeview.demo',   phone: '+91 98207 77777', title: 'Senior Oncologist',            account_id: 'demo-acct-1', account_name: 'Sunrise Hospitals Enterprise',     owner_id: 'demo-user-id', owner_name: MRS[1] },
  { id: 'demo-ctc-8', first_name: 'Dr. Aditya', last_name: 'Nair',      email: 'dr.anair@crescent.demo',        phone: '+91 98211 12121', title: 'Consultant Endocrinologist',  account_id: 'demo-acct-3', account_name: 'Crescent Healthcare',                owner_id: 'demo-user-id', owner_name: MRS[2] },
  { id: 'demo-ctc-9', first_name: 'Dr. Karan',  last_name: 'Verma',     email: 'dr.kverma@northgate.demo',       phone: '+91 98210 10101', title: 'Sr. Neurologist',              account_id: 'demo-acct-3', account_name: 'Crescent Healthcare',                owner_id: 'demo-user-id', owner_name: MRS[0] },
  { id: 'demo-ctc-10', first_name: 'Dr. R. K.', last_name: 'Tandon',    email: 'rk.tandon@metropolis.demo',          phone: '+91 98213 14141', title: 'Director — Oncology',          account_id: 'demo-acct-7', account_name: 'Metropolis Cancer Centre',             owner_id: 'demo-user-id', owner_name: MRS[1] }
];
...
export const CRM_DEALS = [
  ...
  { id: 'demo-deal-6',  name: 'Dr. Manish Khanna — Oncevia adoption',        account_id: 'demo-acct-1', account_name: 'Sunrise Hospitals Enterprise',     pipeline_id: 'demo-pipe', stage_id: 'demo-stg-5', stage_name: 'Adopted Prescriber',  stage_type: 'open', status: 'open', amount: 1980000,  currency: 'INR', probability: 82,  win_probability_ai: 86,  owner_id: 'demo-user-id', owner_name: MRS[1], expected_close_date: _now(4).slice(0, 10),  created_at: _now(-22) },
  { id: 'demo-deal-7',  name: 'Dr. Aditya Nair — Glucanova switch from Ozempic', account_id: 'demo-acct-3', account_name: 'Crescent Healthcare',              pipeline_id: 'demo-pipe', stage_id: 'demo-stg-2', stage_name: 'Detailing Visit',     stage_type: 'open', status: 'open', amount: 2460000,  currency: 'INR', probability: 25,  win_probability_ai: 38,  owner_id: 'demo-user-id', owner_name: MRS[2], expected_close_date: _now(22).slice(0, 10), created_at: _now(-10) },
...
export const CRM_PRODUCTS = [
  ...
  { id: 'demo-prod-8', name: 'Glyzentia (Empagliflozin) 25mg',sku:'VRN-JAR-25', unit_price:  1280, unit: 'pack/30', is_active: true }
];
...
export const CRM_LEADS_AT_RISK = [
  ...
  { lead_id: 'demo-lead-13', name: 'Dr. Rajeev Krishnan (Diabextra)', score: 86, owner_id: 'demo-user-id', days_idle: 19 }
];
...
export const CRM_WA_TEMPLATES_SEED = [
  { id: 'demo-wa-tpl-1', org_id: 'demo-org-999', meta_template_name: 'cme_invite',          category: 'marketing', language: 'en', status: 'approved', header_text: 'CME Invitation', body_text: 'Dear Dr. {{1}}, you are invited to the Vireon Pharma CME on {{2}} (topic: {{3}}). RSVP at the link below.', footer_text: 'Vireon Pharma India', variables: ['last_name', 'date', 'topic'], created_at: _now(-30), updated_at: _now(-30) },
  { id: 'demo-wa-tpl-2', org_id: 'demo-org-999', meta_template_name: 'sample_dispatched',   category: 'utility',   language: 'en', status: 'approved', header_text: 'Samples Sent',   body_text: 'Dr. {{1}}, your requested {{2}} samples have been dispatched. They will reach your clinic in 2-3 working days.',                            footer_text: 'Vireon Pharma India', variables: ['last_name', 'product'], created_at: _now(-14), updated_at: _now(-14) },
  { id: 'demo-wa-tpl-3', org_id: 'demo-org-999', meta_template_name: 'patient_support_psp', category: 'utility',   language: 'en', status: 'pending',  header_text: null,             body_text: 'Hi {{1}}, the Vireon Pharma Patient Support Program covers up to 30% of Glucanova therapy cost. Reply YES to enrol your patient.',                                    footer_text: null,             variables: ['first_name'], created_at: _now(-3),  updated_at: _now(-3) }
];
...
export const CRM_CUSTOM_FIELDS_SEED: Array<Record<string, unknown>> = [
  ...
  { id: 'pharma-cf-2',  org_id: 'demo-org-999', client_id: null, entity_type: 'lead', field_key: 'product_interest',       label: 'Product Interest',       field_type: 'select',   required: true,  position: 1, is_active: true, options: ['Glucanova', 'Diabextra', 'Insulora', 'Oncevia', 'Rheumolex', 'Migranova', 'Oncorib', 'Glyzentia'], created_at: _now(-30), updated_at: _now(-30) },
