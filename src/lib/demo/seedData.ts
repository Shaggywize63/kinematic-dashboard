...
export const CRM_LEADS = [
  { id: 'demo-lead-1',  first_name: 'Vikram',   last_name: 'Reddy',  company: 'Skyline Developers',     email: 'vikram@skyline.demo',   phone: '+91 98201 11111', status: 'qualified',   score: 88, score_grade: 'A', city: 'Bengaluru', state: 'Karnataka', latitude: 12.9716, longitude: 77.5946, industry: 'Real Estate',    owner_id: 'demo-user-id', owner_name: REPS[0], last_activity_at: _now(-1),  created_at: _now(-14) },
  { id: 'demo-lead-2',  first_name: 'Anjali',   last_name: 'Iyer',   company: 'Zenith Properties',      email: 'anjali@zenith.demo',    phone: '+91 98202 22222', status: 'working',     score: 76, score_grade: 'A', city: 'Mumbai', state: 'Maharashtra', latitude: 19.076, longitude: 72.8777,    industry: 'Construction',   owner_id: 'demo-user-id', owner_name: REPS[1], last_activity_at: _now(-2),  created_at: _now(-21) },
  { id: 'demo-lead-3',  first_name: 'Rohan',    last_name: 'Kumar',  company: 'Acme Steel',             email: 'rohan@acme.demo',       phone: '+91 98203 33333', status: 'new',         score: 64, score_grade: 'B', city: 'Pune', state: 'Maharashtra', latitude: 18.5204, longitude: 73.8567,      industry: 'Steel',          owner_id: 'demo-user-id', owner_name: REPS[2], last_activity_at: _now(-4),  created_at: _now(-7)  },
  { id: 'demo-lead-4',  first_name: 'Neha',     last_name: 'Gupta',  company: 'Vega Infra',             email: 'neha@vegainfra.demo',   phone: '+91 98204 44444', status: 'qualified',   score: 92, score_grade: 'A', city: 'Hyderabad', state: 'Telangana', latitude: 17.385, longitude: 78.4867, industry: 'Infrastructure', owner_id: 'demo-user-id', owner_name: REPS[0], last_activity_at: _now(-1),  created_at: _now(-30) },
  { id: 'demo-lead-5',  first_name: 'Karthik',  last_name: 'Pillai', company: 'Trident Power',          email: 'karthik@trident.demo',  phone: '+91 98205 55555', status: 'working',     score: 55, score_grade: 'B', city: 'Chennai', state: 'Tamil Nadu', latitude: 13.0827, longitude: 80.2707,   industry: 'Energy',         owner_id: 'demo-user-id', owner_name: REPS[3], last_activity_at: _now(-5),  created_at: _now(-18) },
  { id: 'demo-lead-6',  first_name: 'Pooja',    last_name: 'Joshi',  company: 'Lakshmi Builders',       email: 'pooja@lakshmi.demo',    phone: '+91 98206 66666', status: 'unqualified', score: 22, score_grade: 'D', city: 'Jaipur', state: 'Rajasthan', latitude: 26.9124, longitude: 75.7873,    industry: 'Real Estate',    owner_id: 'demo-user-id', owner_name: REPS[4], last_activity_at: _now(-9),  created_at: _now(-35) },
  { id: 'demo-lead-7',  first_name: 'Manish',   last_name: 'Khanna', company: 'Konkan Steel',           email: 'manish@konkan.demo',    phone: '+91 98207 77777', status: 'qualified',   score: 81, score_grade: 'A', city: 'Mumbai', state: 'Maharashtra', latitude: 19.1136, longitude: 72.8697,    industry: 'Steel',          owner_id: 'demo-user-id', owner_name: REPS[1], last_activity_at: _now(-3),  created_at: _now(-25) },
  { id: 'demo-lead-8',  first_name: 'Ishaan',   last_name: 'Bose',   company: 'Falcon Engineering',     email: 'ishaan@falcon.demo',    phone: '+91 98208 88888', status: 'nurturing',   score: 48, score_grade: 'C', city: 'Kolkata', state: 'West Bengal', latitude: 22.5726, longitude: 88.3639,   industry: 'Manufacturing',  owner_id: 'demo-user-id', owner_name: REPS[2], last_activity_at: _now(-12), created_at: _now(-42) },
  { id: 'demo-lead-9',  first_name: 'Tanvi',    last_name: 'Mehta',  company: 'Pragati Industries',     email: 'tanvi@pragati.demo',    phone: '+91 98209 99999', status: 'new',         score: 70, score_grade: 'B', city: 'Ahmedabad', state: 'Gujarat', latitude: 23.0225, longitude: 72.5714, industry: 'Manufacturing',  owner_id: 'demo-user-id', owner_name: REPS[3], last_activity_at: _now(-1),  created_at: _now(-5)  },
  { id: 'demo-lead-10', first_name: 'Karan',    last_name: 'Verma',  company: 'Suryadev Cement',        email: 'karan@suryadev.demo',   phone: '+91 98210 10101', status: 'working',     score: 84, score_grade: 'A', city: 'Surat', state: 'Gujarat', latitude: 21.1702, longitude: 72.8311,     industry: 'Cement',         owner_id: 'demo-user-id', owner_name: REPS[0], last_activity_at: _now(-2),  created_at: _now(-11) },
  { id: 'demo-lead-11', first_name: 'Aditya',   last_name: 'Nair',   company: 'Helios Constructions',   email: 'aditya@helios.demo',    phone: '+91 98211 12121', status: 'qualified',   score: 78, score_grade: 'A', city: 'Delhi', state: 'Delhi', latitude: 28.6139, longitude: 77.209,     industry: 'Construction',   owner_id: 'demo-user-id', owner_name: REPS[1], last_activity_at: _now(-1),  created_at: _now(-28) },
  { id: 'demo-lead-12', first_name: 'Diya',     last_name: 'Kapoor', company: 'Coromandel Logistics',   email: 'diya@coromandel.demo',  phone: '+91 98212 13131', status: 'new',         score: 36, score_grade: 'C', city: 'Chennai', state: 'Tamil Nadu', latitude: 13.0475, longitude: 80.209,   industry: 'Logistics',      owner_id: 'demo-user-id', owner_name: REPS[2], last_activity_at: _now(-6),  created_at: _now(-9)  }
];
