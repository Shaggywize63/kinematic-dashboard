...
export const CRM_LEADS = [
  ...
  { id: 'demo-lead-3',  first_name: 'Rohan',   last_name: 'Kumar',    company: '', email: 'rohan.kumar@mail.demo',     phone: '+91 98203 33333', status: 'new',         score: 64, score_grade: 'B', city: 'Pune',      industry: 'Insurance', product_interest: 'Endowment',   annual_premium: 60000,  sum_assured: 1500000,  owner_id: 'demo-user-id', owner_name: ADV[2], source_id: 'demo-src-3', last_activity_at: _now(-4),  created_at: _now(-7)  },
  { id: 'demo-lead-4',  first_name: 'Neha',    last_name: 'Gupta',    company: '', email: 'neha.gupta@mail.demo',      phone: '+91 98204 44444', status: 'qualified',   score: 92, score_grade: 'A', city: 'Hyderabad', industry: 'Insurance', product_interest: 'Child Plan',  annual_premium: 90000,  sum_assured: 2000000,  owner_id: 'demo-user-id', owner_name: ADV[0], source_id: 'demo-src-4', last_activity_at: _now(-1),  created_at: _now(-30) },
  ...
  { id: 'demo-lead-6',  first_name: 'Pooja',   last_name: 'Joshi',    company: '', email: 'pooja.joshi@mail.demo',     phone: '+91 98206 66666', status: 'unqualified', score: 22, score_grade: 'D', city: 'Jaipur',    industry: 'Insurance', product_interest: 'Health',      annual_premium: 18000,  sum_assured: 500000,   owner_id: 'demo-user-id', owner_name: ADV[4], source_id: 'demo-src-6', last_activity_at: _now(-9),  created_at: _now(-35) },
