      ...
      {!form.is_b2c ? (
        ...
        <>
          ...
          <Grid>
            ...
            <SelectField label="Loyalty Tier" value={form.loyalty_tier}
              options={[{ value: '', label: '—' }, { value: 'bronze', label: 'Bronze' }, { value: 'silver', label: 'Silver' }, { value: 'gold', label: 'Gold' }, { value: 'platinum', label: 'Platinum' }, { value: 'vip', label: 'VIP' }]}
              onChange={(v) => setForm({ ...form, loyalty_tier: v })} />
            <Field label="Referral Source" value={form.referral_source} onChange={(v) => setForm({ ...form, referral_source: v })} />
          </Grid>
