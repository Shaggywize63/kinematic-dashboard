'use client';
/**
 * Renders widgets the user has pinned from the Lead Analytics page,
 * to surface on the CRM Overview at the top. Compact — drag/resize
 * disabled here; users go to /dashboard/crm/leads/analytics for the
 * full customiser.
 *
 * Renders nothing when no widgets have been pinned yet, so it's safe
  ...
  return (
    <div style={{ background: 'var(--s2)', border: '1px solid var(--border)', borderRadius: 14, padding: 18 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
        ...
        <Link href="/dashboard/crm/leads/analytics" style={{
          marginLeft: 'auto', fontSize: 11, color: 'var(--primary)', textDecoration: 'none', fontWeight: 600,
        }}>
          Open Lead Analytics →
        </Link>
      </div>
