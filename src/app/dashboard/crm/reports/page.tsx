...
const REPORTS: ReportEntry[] = [
  ...
  { href: '/dashboard/crm/reports/activity-report', title: '🗓 Activity Report', desc: 'Every logged activity with lead, directory (dealer) and notes — one row per activity.', srsOnly: true },
  { href: '/dashboard/crm/reports/test-report', title: '🧪 Test Report', desc: 'Leads where a Ring or Weighment test was recorded, with attendee count.', srsOnly: true },
  { href: '/dashboard/crm/reports/daywise-report', title: '📆 Day-Wise Report', desc: 'Per-rep, per-day rollup: activity split, unique leads, deals and tonnage, with a grand total.', srsOnly: true },
