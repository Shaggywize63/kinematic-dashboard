...
export default function NewAccountPage() {
  ...
  const [form, setForm] = useState({ name: '', industry: '', website: '', phone: '', annual_revenue: '', employees: '', photo_url: '' });
  ...
  const fld = (k: 'name' | 'industry' | 'website' | 'phone' | 'annual_revenue' | 'employees', label: string, type = 'text') => (
  ...
  return (
    <form onSubmit={submit} style={{ background: 'var(--s2)', border: '1px solid var(--border)', borderRadius: 14, padding: 24, maxWidth: 720 }}>
      ...
      <CRMPhotoSection
        ...
        title="Account Logo / Photo (optional)"
        helperText="Upload the company logo, a shop-front photo, or anything that helps your team recognise this account at a glance."
      />
