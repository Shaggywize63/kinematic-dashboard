...
export default function PlanogramLibraryPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      {/* Sub-header: definitions library sits under the module topbar. */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
        <div style={{ fontSize: 13, color: C.gray }}>
          Expected shelf layouts per store format — recognition scores captures against these.
        </div>
        <button
          onClick={fetchAll}
          style={{
      ...
      >
        <div style={{ fontFamily: 'var(--font-manrope)', fontSize: 14, fontWeight: 700, marginBottom: 10 }}>
...
function Kpi({ label, value, accent }: { label: string; value: string | number; accent: string }) {
  return (
    ...
    >
      <div style={{ fontFamily: 'var(--font-manrope)', fontSize: 26, fontWeight: 800, color: accent }}>
        {value}
      </div>
